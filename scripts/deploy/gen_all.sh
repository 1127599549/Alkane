...
python3 ../gen_conf.py --ips replicas_inter.txt --iter 1 --prefix 'hotstuff.gen' --keygen ../../hotstuff-keygen --tls-keygen ../../hotstuff-tls-keygen --sb-users 1000000 --sb-prob-choose_mtx 0.9 --sb-skew-factor 0.1 --fairness-parameter 0.5 --block-size 100 --clinworker 1 --nworker 1 --repnworker 1 --repburst 100 --cliburst 1000
